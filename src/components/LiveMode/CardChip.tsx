...
import { CARD_COLOR_BG, CARD_COLOR_BORDER, getCardColorKey, getGradientChipStyle } from '@/lib/cardColors';
...
export const CardChip = forwardRef<HTMLDivElement, CardChipProps>(({ card, className, style, ...props }, ref) => {
    ...
    return (
        <div
            ...
            className={cn(
                ...
                !gradient && CARD_COLOR_BORDER[getCardColorKey(card.colors)],
                className,
            )}
