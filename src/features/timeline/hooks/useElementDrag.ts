...
function makeClipGhost(el: ClipElement, newTime: number, zoom: number): ClipGhostPos {
    return {
        left: newTime * zoom,
...
function buildGroupBoundaries(groups: Array<{ id: string; tracks: TimelineTrack[] }>): GroupBoundary[] {
...
export function useElementDrag(
    ...
    eventTrackGroups: Array<{ id: string; tracks: TimelineTrack[] }>,
    ...
    const [clipGhostsByTrack, setClipGhostsByTrack] = useState<Map<string, ClipGhostPos[]>>(new Map());
    ...
    useEffect(() => {
        ...
        const onMouseMove = (e: MouseEvent) => {
            ...
            let primaryTargetTrack: TimelineTrack | undefined;
            ...
            const nextEventGhosts = new Map<string, GhostPos[]>();
            const nextClipGhosts = new Map<string, ClipGhostPos[]>();
